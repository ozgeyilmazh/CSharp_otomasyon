...
{
    public partial class SMalzemeAlis : Form
    {
        public SMalzemeAlis()
        {
            InitializeComponent();
        ...
        private void btn_ekle8_Click(object sender, EventArgs e)
        {
        ...
        private void btn_ekle7_Click(object sender, EventArgs e)
        {
            string sql = "INSERT INTO malzemealis (fatura_no, malzeme, tedarikci, miktar, fiyat, tarih) values (@fat_no,@malzeme,@tedarikci,@miktar,@fiyat,@tarih)";
            string sql2 = "INSERT INTO giderler (fatura_no, tarih, fiyat) values (@fat_no, @tarih,@fiyat)";
        ...
        private void SMalzemeAlis_Load(object sender, EventArgs e)
        {
            #region ComboBox 
            conn.Open();
